...
let Yearly = () => {
    ...
    const schema = yup
        .object({
            ...
            fee: yup.number().typeError("Fee is required").min(25000, 'Fee must be atleast 25000'),
    ...
    return (
        <>
            <div className="bg-gradient-to-br from-[rgb(23,59,69)] via-[rgba(95,179,203,1)] to-[rgb(23,59,69)] px-6 py-24 sm:py-32 lg:px-8 flex justify-center">
                <div ref={gsapRef} className='parent w-[80vw] h-auto bg-gray-100 p-10 rounded-3xl'>
                    <div className="mx-auto max-w-2xl text-center">
                        ...
                        <p className="text mt-2 text-lg/8 text-gray-600">
                            <span className='text-yellow-600'>Yearly Basis</span> - Enjoy your whole year with KARVE
                        </p>
                    </div>
                    <form action="#" method="POST" className="mx-auto mt-16 max-w-xl sm:mt-20" onSubmit={handleSubmit(formSubmitHandler)}>
                        <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                            ...
                            <div className="sm:col-span-2">
                                ...
                                <input id="yearly" type="radio" value='yearly' {...register('membershipType')} />
                            </div>
                            ...
                            <div className="sm:col-span-2">
                                ...
                                <div className="mt-2.5">
                                    <input
                                        placeholder='Yearly membership requires 25,000 PKR'
                                        id="email"
                                        type="number"
                                        autoComplete="email"
                                        className="text block w-full rounded-md bg-white/5 px-3.5 py-2 text-base outline-2 -outline-offset-1 outline-[rgb(52,79,31)] text-gray-700 placeholder:text-gray-500 focus:outline-2 focus:-outline-offset-2 focus:outline-yellow-600"
