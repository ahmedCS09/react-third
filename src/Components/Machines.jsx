...
import machine4 from '../assets/machine4.webp'
...
let Facilities = () => {
  ...
  <div className="px-4 py-16 sm:px-6 sm:py-20 w-screen flex flex-col items-center">
    ...
    <div ref={imgRef} className="mt-6 flex justify-center flex-wrap gap-x-6 gap-y-10 w-[95%]">
      <a href='#m1' className="group relative w-80">
        <img
          src={machine1}
      ...
      <a href='#m2' className="group relative w-80">
        <img
          src={machine2}
      ...
      <a href='#m3' className="group relative w-80">
        <img
          src={machine3}
      ...
      <a href='#m4' className="group relative w-80">
        <img
          src={machine4}
      ...
      <a href='#m5' className="group relative w-80">
        <img
          src={machine5}
          alt="Front of men's Basic Tee in black."
          className="aspect-square w-full rounded-md bg-gray-200 object-cover group-hover:opacity-75 lg:aspect-auto lg:h-80 border"
      ...
      <a href='#m6' className="group relative w-80">
        <img
          src={machine6}
          alt="Front of men's Basic Tee in white."
          className="aspect-square w-full rounded-md bg-gray-200 object-cover group-hover:opacity-75 lg:aspect-auto lg:h-80 border"
