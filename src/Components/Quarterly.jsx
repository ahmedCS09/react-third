...
let Quarterly = () => {
    ...
    const schema = yup
        .object({
            ...
            fee: yup.number().typeError("Fee is required").min(7000, 'Fee must be atleast 7000'),
    ...
    return (
        <>
            <div className="bg-gradient-to-br from-[rgb(52,79,31)] via-[rgba(173,224,135,1)] to-[rgb(52,79,31)] px-6 py-24 sm:py-32 lg:px-8 flex justify-center">
                ...
                <div className="mx-auto max-w-2xl text-center">
                    ...
                    <p className="text mt-2 text-lg/8 text-gray-600">
                        <span className='text-yellow-600'>Quarterly Basis</span> - Enjoy your 3 months with KARVE
                    </p>
                </div>
                <form action="#" method="POST" className="mx-auto mt-16 max-w-xl sm:mt" onSubmit={handleSubmit(formSubmitHandler)}>
                    <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                        ...
                        <div className="sm:col-span-2">
                            ...
                            <input id="quarterly" type="radio" value='quarterly' {...register('membershipType')} />
                        </div>
                        {errors.membershipType && <span className='text-red-600'>{errors.membershipType.message}</span>}
                         <div className="sm:col-span-2">
                            ...
                            <div className="mt-2.5">
                                <input
                                    placeholder='Quarterly membership requires 7,000 PKR'
                                    id="email"
                                    type="number"
                                    autoComplete="email"
                                    className="text block w-full rounded-md bg-white/5 px-3.5 py-2 text-base outline-2 -outline-offset-1 outline-[rgb(52,79,31)] text-gray-700 placeholder:text-gray-500 focus:outline-2 focus:-outline-offset-2 focus:outline-yellow-600"
                    ...
                    <div className="mt-10 w-full flex justify-center">
                        <button
                            type="submit"
                            className="block rounded rounded-md bg-[rgb(52,79,31)] px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-xs hover:bg-[rgba(44,67,27,1)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500"
                        >
                            Submit
                        </button>
                    </div>
